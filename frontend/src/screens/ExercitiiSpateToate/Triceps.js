...
const defaultExercitiiData = {
  "Seated Dumbbell Tricep Extension": {
    descriere: "Exercițiu izolat pentru triceps. Așezat pe o bancă, cu spatele drept, ții o ganteră cu ambele mâini deasupra capului, cu coatele apropiate de urechi. Cobori controlat gantera în spatele capului, menținând coatele fixe, apoi ridici înapoi în poziția inițială prin extinderea completă a tricepsului.",
    video: "https://youtu.be/LlCFtWCQc5s",
    animatie: require('../../../assets/gifs/tricep-extension.png'),
    muschiAntrenati: "Triceps",
    grupaMusculara: "Triceps",
    equipment: "Gantere și bancă",
    isDefault: true
  },
  "EZ Bar Skullcrusher": {
    descriere: "Exercițiu izolat pentru triceps. Așezat pe o bancă, cu spatele drept, ții bara EZ cu ambele mâini la lățimea umerilor. Cu coatele fixe, cobori bara spre frunte, apoi ridici înapoi în poziția inițială prin extinderea completă a tricepsului. Menține coatele apropiate de cap pentru izolarea optimă a tricepsului.",
    video: "https://youtu.be/K6MSN4hCDM4",
    animatie: require('../../../assets/gifs/skullcrusher.png'),
    muschiAntrenati: "Triceps",
    grupaMusculara: "Triceps",
    equipment: "Bară EZ și bancă",
    isDefault: true
  }
};
...
const Triceps = () => {
  ...
  const [grupaMusculara, setGrupaMusculara] = useState('Triceps');
  ...
  const incarcaExercitii = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/exercitii?grupaMusculara=Triceps`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
      ...
      const exercitiiTriceps = data.filter(exercitiu => exercitiu.grupaMusculara === 'Triceps');
      console.log(`Am filtrat ${exercitiiTriceps.length} exerciții pentru Triceps`);
      
      const exercitiiFormatate = { ...defaultExercitiiData };
      
      exercitiiTriceps.forEach(exercitiu => {
      ...
      console.log('Exercițiile pentru Triceps au fost încărcate cu succes');
    } catch (error) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.titlu}>Triceps</Text>
