...
const defaultExercitiiData = {
  "Sit Up": {
    descriere: "Exercițiu clasic pentru abdomen. Întins pe spate cu genunchii îndoiți, ridici trunchiul până la atingerea genunchilor. Lucrează intens mușchii rectus abdominis și oblicii. Poate fi executat cu sau fără greutate suplimentară.",
    video: "https://youtu.be/MQDopvLZOS8",
    animatie: require('../../../assets/gifs/sit-up.png'),
    muschiAntrenati: "Rectus abdominis și oblici",
    grupaMusculara: "Abdomen",
    equipment: "Saltea de exerciții (opțional greutate)",
    isDefault: true
  },
  "Weighted Crunch": {
    descriere: "Exercițiu avansat pentru abdomen. Întins pe spate cu genunchii îndoiți, ții o greutate la piept și ridici doar partea superioară a spatelui de pe sol. Lucrează intens partea superioară a abdomenului. Executat cu mișcare controlată.",
    video: "https://youtu.be/6kHg3JAFNFo",
    animatie: require('../../../assets/gifs/weighted-crunch.png'),
    muschiAntrenati: "Rectus abdominis superior",
    grupaMusculara: "Abdomen",
    equipment: "Saltea de exerciții și greutate (ganteră sau disc)",
    isDefault: true
  }
};
...
const Abdomen = () => {
  ...
  const [grupaMusculara, setGrupaMusculara] = useState('Abdomen');
  ...
  const incarcaExercitii = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/exercitii?grupaMusculara=Abdomen`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
      ...
      // Filtrăm exercițiile pentru a include doar cele cu grupaMusculara = 'Abdomen'
      const exercitiiAbdomen = data.filter(exercitiu => exercitiu.grupaMusculara === 'Abdomen');
      console.log(`Am filtrat ${exercitiiAbdomen.length} exerciții pentru abdomen`);
      
      const exercitiiFormatate = { ...defaultExercitiiData };
      
      exercitiiAbdomen.forEach(exercitiu => {
      ...
      console.log('Exercițiile pentru abdomen au fost încărcate cu succes');
    } catch (error) {
  ...
  const adaugaExercitiu = async () => {
    ...
    try {
      ...
      // Mai întâi adăugăm exercițiul fără imagine
      const exercitiuData = {
        nume: numeExercitiu,
      ...
      // Dacă există imagine, o trimitem separat
      if (imagineSursa) {
      ...
      await incarcaExercitii(); // Reîncărcăm lista de exerciții
  ...
  const actualizeazaExercitiu = async () => {
    ...
    try {
      // Verificăm dacă numele a fost schimbat
      ...
      // Actualizăm exercițiul fără imagine
      const exercitiuData = {
        descriere: descriereExercitiu,
        muschiAntrenati: muschiAntrenati,
        echipament: echipament,
      ...
      // Dacă numele a fost schimbat, îl adăugăm în date
      if (numeExercitiu !== numeOriginal) {
      ...
      // Dacă există o imagine nouă, o trimitem separat
      if (imagineSursa) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.titlu}>Abdomen</Text>
            ...
            <ScrollView contentContainerStyle={styles.scrollViewContent}>
              <View style={styles.formContainer}>
                ...
                <TextInput
                  ...
                  placeholder="Ex: Rectus abdominis"
                  placeholderTextColor="#888"
                />
                ...
                <TextInput
                  ...
                  placeholder="Ex: Saltea de exerciții"
                  placeholderTextColor="#888"
                />
