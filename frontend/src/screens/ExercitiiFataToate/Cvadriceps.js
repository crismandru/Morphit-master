...
const defaultExercitiiData = {
  "Leg Press": {
    descriere: "Exercițiu compus pentru cvadriceps executat pe aparat. Așezat pe banca aparatului, cu picioarele pe platformă, împingi platforma în sus prin extinderea genunchilor. Lucrează intens cvadricepsul, dar și gluteii și fesierii. Poate fi executat cu diferite poziții ale picioarelor pentru a accentua diferite zone ale cvadricepsului.",
    video: "https://youtu.be/sEM_zo9w2ss",
    animatie: require('../../../assets/gifs/leg-press.png'),
    muschiAntrenati: "Cvadriceps, Glutei, Fesieri",
    grupaMusculara: "Cvadriceps",
    equipment: "Aparat Leg Press",
    isDefault: true
  },
  "Barbell Back Squat": {
    descriere: "Exercițiu fundamental pentru picioare. Cu bara pe trapezii superiori, picioarele la lățimea umerilor, cobori controlat până când coapsele sunt paralele cu solul, apoi te ridici în poziția inițială. Lucrează intens cvadricepsul, gluteii, fesierii și mușchii stabilizatori ai trunchiului.",
    video: "https://youtu.be/R2dMsNhN3DE",
    animatie: require('../../../assets/gifs/squat.png'),
    muschiAntrenati: "Cvadriceps, Glutei, Fesieri, Mușchi stabilizatori",
    grupaMusculara: "Cvadriceps",
    equipment: "Bară dreaptă și rack pentru squaturi",
    isDefault: true
  },
  "Leg Extensions": {
    descriere: "Exercițiu izolat pentru cvadriceps executat pe aparat. Așezat pe banca aparatului, cu picioarele sub pernele de susținere, extinzi genunchii pentru a ridica greutatea. Lucrează exclusiv cvadricepsul, fiind ideal pentru izolarea acestui grup muscular.",
    video: "https://youtu.be/0fl1RRgJ83I",
    animatie: require('../../../assets/gifs/leg-extension.png'),
    muschiAntrenati: "Cvadriceps",
    grupaMusculara: "Cvadriceps",
    equipment: "Aparat Leg Extensions",
    isDefault: true
  }
};
...
const Cvadriceps = () => {
  ...
  const [grupaMusculara, setGrupaMusculara] = useState('Cvadriceps');
  ...
  const incarcaExercitii = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/exercitii?grupaMusculara=Cvadriceps`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
      ...
      const exercitiiCvadriceps = data.filter(exercitiu => exercitiu.grupaMusculara === 'Cvadriceps');
      console.log(`Am filtrat ${exercitiiCvadriceps.length} exerciții pentru Cvadriceps`);
      
      const exercitiiFormatate = { ...defaultExercitiiData };
      
      exercitiiCvadriceps.forEach(exercitiu => {
      ...
      console.log('Exercițiile pentru Cvadriceps au fost încărcate cu succes');
    } catch (error) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.titlu}>Cvadriceps</Text>
