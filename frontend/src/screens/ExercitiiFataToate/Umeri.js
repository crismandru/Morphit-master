...
const defaultExercitiiData = {
  "Seated Dumbbell Press": {
    descriere: "Exercițiu compus pentru umeri. Stând jos, împingi ganterele deasupra capului dintr-o poziție de start cu coatele îndoite la 90°. Lucrează deltoizii anteriori și medii și tricepsul.",
    video: "https://youtu.be/FRxZ6wr5bpA",
    animatie: require('../../../assets/gifs/seated-dumbbell-press.png'),
    muschiAntrenati: "Deltoizi anteriori și medii",
    grupaMusculara: "Umeri",
    equipment: "Gantere",
    isDefault: true
  },
  "Arnold Press": {
    descriere: "Exercițiu compus care lucrează toți cei trei deltoizi. Începi cu ganterele la nivelul umerilor și palmele spre tine (supinație), apoi rotești mâinile în timpul ridicării astfel încât palmele să fie orientate în față (pronație) la finalul mișcării.",
    video: "https://www.youtube.com/watch?v=hmnZKRpYaV8",
    animatie: require('../../../assets/gifs/arnold-press.png'),
    muschiAntrenati: "Deltoizi anteriori, laterali și posteriori",
    grupaMusculara: "Umeri",
    equipment: "Gantere",
    isDefault: true
  }
...
const Umeri = () => {
  ...
  const [grupaMusculara, setGrupaMusculara] = useState('Umeri');
  ...
  const incarcaExercitii = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/exercitii?grupaMusculara=Umeri`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
      ...
      const exercitiiUmeri = data.filter(exercitiu => exercitiu.grupaMusculara === 'Umeri');
      console.log(`Am filtrat ${exercitiiUmeri.length} exerciții pentru Umeri`);
      
      const exercitiiFormatate = { ...defaultExercitiiData };
      
      exercitiiUmeri.forEach(exercitiu => {
      ...
      console.log('Exercițiile pentru Umeri au fost încărcate cu succes');
    } catch (error) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.titlu}>Umeri</Text>
